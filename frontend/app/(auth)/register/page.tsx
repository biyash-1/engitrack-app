...
export default function RegisterPage() {
  const { register: signup, user, isLoading: authLoading } = useAuth();
      ...
      <div className="min-h-screen flex flex-col items-center justify-center bg-slate-900 text-white relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center bg-white/5 backdrop-blur-xl border border-white/10 p-8 rounded-2xl shadow-2xl max-w-sm w-full mx-4 text-center">
          <div className="relative flex items-center justify-center w-16 h-16 mb-6">
            ...
            <UserPlus className="text-blue-400 w-6 h-6 animate-pulse" />
          </div>
          <h2 className="text-xl font-bold tracking-wide mb-2 text-white">Creating Account</h2>
          <p className="text-gray-400 text-sm">Setting up your professional dashboard...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-blue-600">Krezona</h1>
